...
\begin{align}
  ...
  Y_{1} &= AB \cdot \overline{ \left( \overline{CD} \right) } + CD \cdot \overline{ \left( \overline{AB} \right) }\\
  Y_{1} &= \overline{ \overline{ \left[ AB \cdot \overline{ \left( \overline{C} + \overline{D} \right) } \right] } } + \overline{ \overline{ \left[ CD \cdot \overline{ \left( \overline{A} + \overline{B} \right) } \right] } } \\
  Y_{1} &= \overline{ \left\{ \overline{ \left[AB \cdot \overline{ \left( \overline{C} + \overline{D} \right) } \right] } \cdot \overline{ \left[ CD \cdot \overline{ \left( \overline{A} + \overline{B} \right) } \right] } \right\} } \label{eq:2.1_NAND}
\end{align}
...
\begin{equation}
  Y_{2} = (\overline{ABC}) + (\overline{ABD}) + (\overline{ACD}) + (\overline{BCD})
\end{equation}
...
\begin{align}
  Y_{2} &= (\overline{ABC}) + (\overline{ABD}) + (\overline{ACD}) + (\overline{BCD})\\
  Y_{2} &= \overline{AB} \cdot (\overline{C} + \overline{D}) + \overline{CD} \cdot (\overline{A} + \overline{B})\\
  Y_{2} &= \overline{AB} \cdot \overline{(CD)} + \overline{CD} \cdot \overline{(AB)}\\
  Y_{2} &= \overline{\overline{ \left[ \overline{AB} \cdot \overline{(CD)} \right] }} + \overline{\overline{ \left[ \overline{CD} \cdot \overline{(AB)} \right] }}\\
  Y_{2} &= \overline{ \left( \overline{ \left[ \overline{AB} \cdot \overline{(CD)} \right] } \cdot \left[ \overline{CD} \cdot \overline{(AB)} \right] \right)} + \\\label{eq:2.2_NAND}
\end{align}
