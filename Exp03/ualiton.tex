...
Temos a questão de que esse circuito seria muito complexo para se implementar
usando uma conversão direta das \textbf{OR} para portas \textbf{NAND} requeridas
no enunciado. Por tanto, também realizaremos alguns passos para minimização da
função booleana.
